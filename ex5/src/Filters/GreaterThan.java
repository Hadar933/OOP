...
/**
 * a class that represents the greater than filter
 */
public class GreaterThan implements GenericFilter {
    ...
    /**
     * adds a file iff its size is larger then the argument provided
