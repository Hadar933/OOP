...
public class validateFilters {
	...
	/**
	 * the main method that performs the entire process
	 * @param allFiles - array representing all the files
	 * @param filter - some filter to check on
	 * @param isFilterNot - boolean representing if NOT is in the command line
	 * @return - the relevant filtered array
	 */
