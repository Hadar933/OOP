...
public class BasicAPITests {
    ...
    public static void initWords(){
        if(allWords){
            wordsData1 = Ex4Utils.file2array("data1.txt");
            wordsData2 = Ex4Utils.file2array("data2.txt");
        }
        else{
            String[] allWords1 = Ex4Utils.file2array("data1.txt");
            String[] allWords2 = Ex4Utils.file2array("data2.txt");
